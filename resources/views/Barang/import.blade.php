            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="custom-file">
                        ...
                        <label class="custom-file-label" for="file_barang">Pilih berkas...</label>
                    </div>
                    <small id="error-file_barang" class="error-text form-text text-danger mt-1"></small>
                </div>
            </div>
...
<script>
    document.getElementById('file_barang').addEventListener('change', function(e) {
